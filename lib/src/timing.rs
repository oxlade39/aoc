...
mod tests {
    ...
    fn test_format() {
        ...
        assert_eq!("340 µs", format_elapsed_time(Duration::from_secs_f64(0.00034)));
        assert_eq!("34 µs", format_elapsed_time(Duration::from_secs_f64(0.000034)));
        assert_eq!("3 µs", format_elapsed_time(Duration::from_secs_f64(0.0000034)));
        assert_eq!("340 ns", format_elapsed_time(Duration::from_secs_f64(0.00000034)));
    }
}